...
export default function ChatItems() {
	...
	return (
		<div
			className='hidden des:flex items-center justify-center mt-[max(3rem,48px)]'
			ref={chatItemsRef}>
			<div className='relative'>
				<button
					className='flex items-center justify-center size-[max(4.063rem,65px)]
        ...
        w-[max(42.563rem,681px)] p-[max(1.5rem,24px)] rounded-[max(2rem,32px)]
        shadow-[0px_0px_4px_4px_#2C59C34D] absolute left-1/2 -translate-x-1/2
        -top-[max(7rem,112px)] pointer-events-none z-2
        '
        ...
        '>
					...
					<div>
						...
						<p className='text-16 font-medium mt-[max(0.5rem,8px)]'>
        ...
        flex items-center gap-[max(1.5rem,24px)] h-[max(7.063rem,113px)]
        w-[max(42.563rem,681px)] p-[max(1.5rem,24px)] rounded-[max(2rem,32px)]
        shadow-[0px_0px_4px_4px_#2C59C34D] absolute left-3/4 -translate-x-1/2
        -top-[max(13rem,208px)] pointer-events-none z-2
        '
					data-selector='chat-item-box'>
					<div
						className='flex items-center justify-center size-[max(4.063rem,65px)]
